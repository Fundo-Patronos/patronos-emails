/**
 * Send Lembrete 3 - Voz do Doador 2026
 * Third reminder email for survey response
 *
 * Recipients: All donors from CSV
 * Originally scheduled: Feb 24, 2026
 * Sending: Mar 11, 2026 (final reminder)
 */
...
async function main() {
  ...
  console.log('LEMBRETE 3 - VOZ DO DOADOR 2026');
  console.log('='.repeat(60));
  ...
  if (failedBatches.length > 0) {
    ...
    console.log(`\n⚠️  ${pendingEmails.length} emails pendentes salvos em: pending_lembrete3.json`);
  }
}
