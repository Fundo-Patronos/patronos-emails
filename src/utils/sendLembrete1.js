/**
 * Send Lembrete 1 - Voz do Doador 2026
 * First reminder email for survey response
 *
 * Recipients: All 216 donors from CSV
 * Sent: Immediately (originally scheduled Feb 14, 2026)
 */
...
async function main() {
  ...
  console.log('LEMBRETE 1 - VOZ DO DOADOR 2026');
  console.log('='.repeat(60));
