...
/**
 * 9ª Edição do Jantar de Executivos - Convite
 * Email de convite para executivos e alumni da Unicamp
 */
export default function JantarExecutivos9Edicao() {
  return (
    <Html>
      <Head />
      <Preview>Convite exclusivo: 9ª Edição do Jantar de Executivos - Fundo Patronos</Preview>
        ...
        <Container className="mx-auto max-w-[600px] rounded-[8px] bg-white p-[32px] my-[40px]">
          ...
          <Section className="mb-[32px]">
            <Img
              ...
              alt="9ª Edição do Jantar de Executivos - Fundo Patronos"
              width="536"
              style={{
                width: '100%',
                height: 'auto',
          ...
          <Section className="mb-[32px]">
            ...
            >
              9ª Edição do Jantar de Executivos
            </Heading>
            <Text style={{ marginTop: '16px', marginBottom: '0', fontSize: '16px', color: brand.colors.text.secondary, lineHeight: '28px', textAlign: 'justify'}}>
              É com grande satisfação que o Fundo Patrimonial Patronos convida você para a 9ª Edição do Jantar de Executivos, reunindo líderes, empreendedores e alumni da Unicamp em uma noite de conexões estratégicas e visões de futuro.
            </Text>
            <Text style={{ marginTop: '16px', marginBottom: '0', fontSize: '16px', color: brand.colors.text.secondary, lineHeight: '28px', textAlign: 'justify'}}>
              Esta edição contará com a presença especial do <strong style={{ color: brand.colors.text.primary }}>Prof. Paulo Cesar Montagner</strong>, reitor da Unicamp, que trará reflexões sobre o futuro da universidade pública e suas estratégias para a gestão da instituição.
            </Text>
          </Section>
              ...
              <tbody>
                <tr>
                  <td style={{ width: '80px', verticalAlign: 'top', paddingRight: '12px' }}>
                    <Img
                      src="https://www.gr.unicamp.br/wp-content/uploads/sites/9/2025/05/LUC_8189-Editada2.jpg"
                      alt="Prof. Paulo Cesar Montagner"
                      width="72"
                      height="72"
                      style={{
                        width: '72px',
                  ...
                  <td style={{ fontSize: '16px', color: brand.colors.text.secondary, lineHeight: '28px', verticalAlign: 'top' }}>
                    <strong style={{ color: brand.colors.gradient.stops.orange }}>Prof. Paulo Cesar Montagner</strong>
                    <br />
                    <span style={{ fontSize: '13px', color: brand.colors.text.light, lineHeight: '20px' }}>
                      Reitor da Unicamp · Professor Titular da Faculdade de Educação Física (FEF) · Doutor em Educação Física pela Unicamp
                    </span>
                  </td>
                </tr>
              </tbody>
          ...
          <Section className="mb-[32px]" style={{ backgroundColor: brand.colors.background.gray, borderRadius: '8px', padding: '24px' }}>
            ...
            <Text style={{ margin: '0', fontSize: '16px', color: brand.colors.text.secondary, lineHeight: '28px', textAlign: 'left', fontStyle: 'italic' }}>
              Durante o evento, convidaremos os presentes a realizarem novas doações para apoiar as iniciativas apresentadas do Fundo Patronos.
            </Text>
          </Section>

          {/* CTA - Confirmar Presença */}
          <Section style={{ textAlign: 'center', marginTop: '32px', marginBottom: '32px' }}>
            <Button href="https://tally.so/r/Y5JM2B" variant="primary">
              Confirmar Presença
            </Button>
          </Section>
